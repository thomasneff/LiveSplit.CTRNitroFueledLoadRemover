...
{
  class CTRNitroFueledLoadRemoverComponent : IComponent
  {
    ...
    public CTRNitroFueledLoadRemoverSettings settings { get; set; }
    ...
    public CTRNitroFueledLoadRemoverComponent(LiveSplitState state)
    {
      ...
      settings = new CTRNitroFueledLoadRemoverSettings(state);
